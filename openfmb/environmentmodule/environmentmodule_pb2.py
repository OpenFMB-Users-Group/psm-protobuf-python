...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_ENVIRONMENTREADING'].fields_by_name['conductingEquipmentTerminalReading']._loaded_options = None
  _globals['_ENVIRONMENTREADING'].fields_by_name['conductingEquipmentTerminalReading']._serialized_options = b'\200\265\030\001'
  _globals['_ENVIRONMENTREADINGPROFILE'].fields_by_name['readingMessageInfo']._loaded_options = None
  _globals['_ENVIRONMENTREADINGPROFILE'].fields_by_name['readingMessageInfo']._serialized_options = b'\200\265\030\001'
  _globals['_ENVIRONMENTREADINGPROFILE'].fields_by_name['sensor']._loaded_options = None
  _globals['_ENVIRONMENTREADINGPROFILE'].fields_by_name['sensor']._serialized_options = b'\210\265\030\001\220\265\030\001'
  _globals['_ENVIRONMENTREADINGPROFILE'].fields_by_name['environmentReading']._loaded_options = None
  _globals['_ENVIRONMENTREADINGPROFILE'].fields_by_name['environmentReading']._serialized_options = b'\210\265\030\001\220\265\030\001'
  _globals['_ENVIRONMENTREADINGPROFILE']._loaded_options = None
  _globals['_ENVIRONMENTREADINGPROFILE']._serialized_options = b'\300\363\030\001'
