...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_RESERVEMARGIN'].fields_by_name['logicalNode']._loaded_options = None
  _globals['_RESERVEMARGIN'].fields_by_name['logicalNode']._serialized_options = b'\200\265\030\001'
  _globals['_ALLOCATEDMARGIN'].fields_by_name['requestID']._loaded_options = None
  _globals['_ALLOCATEDMARGIN'].fields_by_name['requestID']._serialized_options = b'\210\265\030\001\220\265\030\001'
  _globals['_RESERVEAVAILABILITYPROFILE'].fields_by_name['controlMessageInfo']._loaded_options = None
  _globals['_RESERVEAVAILABILITYPROFILE'].fields_by_name['controlMessageInfo']._serialized_options = b'\200\265\030\001'
  _globals['_RESERVEAVAILABILITYPROFILE'].fields_by_name['requesterCircuitSegmentService']._loaded_options = None
  _globals['_RESERVEAVAILABILITYPROFILE'].fields_by_name['requesterCircuitSegmentService']._serialized_options = b'\210\265\030\001\220\265\030\001'
  _globals['_RESERVEAVAILABILITYPROFILE'].fields_by_name['reserveAvailability']._loaded_options = None
  _globals['_RESERVEAVAILABILITYPROFILE'].fields_by_name['reserveAvailability']._serialized_options = b'\210\265\030\001\220\265\030\001'
  _globals['_RESERVEAVAILABILITYPROFILE'].fields_by_name['responderCircuitSegmentService']._loaded_options = None
  _globals['_RESERVEAVAILABILITYPROFILE'].fields_by_name['responderCircuitSegmentService']._serialized_options = b'\210\265\030\001\220\265\030\001'
  _globals['_RESERVEAVAILABILITYPROFILE'].fields_by_name['tiePoint']._loaded_options = None
  _globals['_RESERVEAVAILABILITYPROFILE'].fields_by_name['tiePoint']._serialized_options = b'\210\265\030\001\220\265\030\001'
  _globals['_RESERVEAVAILABILITYPROFILE']._loaded_options = None
  _globals['_RESERVEAVAILABILITYPROFILE']._serialized_options = b'\300\363\030\001'
  _globals['_RESERVEREQUEST'].fields_by_name['requestID']._loaded_options = None
  _globals['_RESERVEREQUEST'].fields_by_name['requestID']._serialized_options = b'\210\265\030\001\220\265\030\001'
  _globals['_RESERVEREQUESTPROFILE'].fields_by_name['controlMessageInfo']._loaded_options = None
  _globals['_RESERVEREQUESTPROFILE'].fields_by_name['controlMessageInfo']._serialized_options = b'\200\265\030\001'
  _globals['_RESERVEREQUESTPROFILE'].fields_by_name['requesterCircuitSegmentService']._loaded_options = None
  _globals['_RESERVEREQUESTPROFILE'].fields_by_name['requesterCircuitSegmentService']._serialized_options = b'\210\265\030\001\220\265\030\001'
  _globals['_RESERVEREQUESTPROFILE'].fields_by_name['reserveRequest']._loaded_options = None
  _globals['_RESERVEREQUESTPROFILE'].fields_by_name['reserveRequest']._serialized_options = b'\210\265\030\001\220\265\030\001'
  _globals['_RESERVEREQUESTPROFILE'].fields_by_name['responderCircuitSegmentService']._loaded_options = None
  _globals['_RESERVEREQUESTPROFILE'].fields_by_name['responderCircuitSegmentService']._serialized_options = b'\210\265\030\001\220\265\030\001'
  _globals['_RESERVEREQUESTPROFILE'].fields_by_name['tiePoint']._loaded_options = None
  _globals['_RESERVEREQUESTPROFILE'].fields_by_name['tiePoint']._serialized_options = b'\210\265\030\001\220\265\030\001'
  _globals['_RESERVEREQUESTPROFILE']._loaded_options = None
  _globals['_RESERVEREQUESTPROFILE']._serialized_options = b'\300\363\030\001'
